  ...
  return (
    ...
    >
      <div className="max-w-xs flex flex-col items-center gap-4">
        <div className="text-destructive">{bugIcon}</div>
        <h1 className="text-2xl font-bold text-center">
          Oops! Quelque chose s'est mal passé...
        </h1>
      </div>
      <div className="text-lg max-w-xs [&>*]:text-center">
        <p>
          Veuillez réessayer plus tard ou me contacter par mail si le problème
          persiste :
        </p>
        <p>
          <Button variant="link" asChild>
            <Link href="mailto:contact@vrai-architecture.fr">
              contact@vrai-architecture.fr
            </Link>
          </Button>
        </p>
